...
2. Limit total position we can hold for our ticker (e.g. We can hold at maximum 200 shares or short 200 shares) (#component2)
3. Limit number of entry orders per day (e.g. We can only send 6 entry orders a day) (#component3)
